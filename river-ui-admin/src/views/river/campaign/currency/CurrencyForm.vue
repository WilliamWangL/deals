  ...
  <Dialog :title="dialogTitle" v-model="dialogVisible" width="600px">
    ...
    >
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item label="货币代码" prop="code">
            <el-input v-model="formData.code" placeholder="如: USD" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-form-item label="货币名称" prop="name">
        <el-input v-model="formData.name" placeholder="请输入货币名称" />
      </el-form-item>
      <el-form-item label="小数位数" prop="decimalPlaces">
        <el-input-number v-model="formData.decimalPlaces" :min="0" :max="4" class="!w-full" />
      </el-form-item>
