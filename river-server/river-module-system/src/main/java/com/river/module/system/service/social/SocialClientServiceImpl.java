package com.river.module.system.service.social;
...
import com.river.framework.common.util.cache.CacheUtils;
import com.river.framework.common.util.http.HttpUtils;
import com.river.framework.common.util.object.BeanUtils;
import com.river.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.river.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.river.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.river.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.river.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.river.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.river.module.system.dal.dataobject.social.SocialClientDO;
import com.river.module.system.dal.mysql.social.SocialClientMapper;
import com.river.module.system.dal.redis.RedisKeyConstants;
import com.river.module.system.enums.social.SocialTypeEnum;
import com.river.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.river.framework.common.util.collection.MapUtils.findAndThen;
import static com.river.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.river.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.river.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${river.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${river.wxa-subscribe-message.miniprogram-state:formal}")
