package com.river.module.system.service.user;
...
import com.river.framework.common.util.collection.ArrayUtils;
import com.river.framework.common.util.collection.CollectionUtils;
import com.river.framework.test.core.ut.BaseDbUnitTest;
import com.river.module.infra.api.config.ConfigApi;
import com.river.module.infra.api.file.FileApi;
import com.river.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.river.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.river.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.river.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.river.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.river.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.river.module.system.dal.dataobject.dept.DeptDO;
import com.river.module.system.dal.dataobject.dept.PostDO;
import com.river.module.system.dal.dataobject.dept.UserPostDO;
...
import com.river.module.system.dal.mysql.dept.UserPostMapper;
import com.river.module.system.dal.mysql.user.AdminUserMapper;
import com.river.module.system.enums.common.SexEnum;
import com.river.module.system.service.dept.DeptService;
import com.river.module.system.service.dept.PostService;
import com.river.module.system.service.oauth2.OAuth2TokenService;
import com.river.module.system.service.permission.PermissionService;
...
import static com.river.framework.common.util.collection.SetUtils.asSet;
import static com.river.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.river.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.river.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.river.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.river.framework.test.core.util.AssertUtils.assertServiceException;
import static com.river.framework.test.core.util.RandomUtils.*;
import static com.river.module.system.enums.ErrorCodeConstants.*;
import static com.river.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("riveryuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("riveryuanma");
        ...
        assertEquals("riveryuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("riveryuanma"))).thenReturn("java");
