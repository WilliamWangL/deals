...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.river";
    private static final String ARTIFACT_ID = "river";
    private static final String PACKAGE_NAME = "com.river";
    private static final String TITLE = "River广告管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.river";
        String artifactIdNew = "river";
        String packageNameNew = "com.river";
        String titleNew = "River广告管理系统";
        String projectBaseDirNew = projectBaseDir.replace("ruoyi-vue-pro", "river-server"); // 一键改名后，"新"项目所在的目录
