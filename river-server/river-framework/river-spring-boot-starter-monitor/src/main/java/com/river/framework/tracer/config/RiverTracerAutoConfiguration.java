package com.river.framework.tracer.config;

import com.river.framework.common.enums.WebFilterOrderEnum;
import com.river.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "river.tracer", value = "enable", matchIfMissing = true)
public class RiverTracerAutoConfiguration {
