package com.river.framework.web.config;
...
import com.river.framework.web.core.filter.CacheRequestBodyFilter;
import com.river.framework.web.core.filter.DemoFilter;
import com.river.framework.web.core.handler.GlobalExceptionHandler;
import com.river.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class RiverWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "river.demo", havingValue = "true")
