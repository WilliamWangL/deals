package com.river.module.infra.service.logger;
...
import com.river.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.river.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.river.module.infra.dal.mysql.logger.ApiErrorLogMapper;
...
import static com.river.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.river.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.river.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("river-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("river-test");
