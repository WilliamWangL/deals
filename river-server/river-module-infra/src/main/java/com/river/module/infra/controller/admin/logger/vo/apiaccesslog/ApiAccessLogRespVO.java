package com.river.module.infra.controller.admin.logger.vo.apiaccesslog;

import com.river.framework.excel.core.annotations.DictFormat;
import com.river.framework.excel.core.convert.DictConvert;
import com.river.module.infra.enums.DictTypeConstants;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.river.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
