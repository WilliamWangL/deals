...
This file provides guidance to Claude Code (claude.ai/code) when working with the river-server backend.

## 项目概述

River 广告平台后端服务，基于 Spring Boot 3.5 + Java 17 + PostgreSQL 17。
...
使用 `Skill` 工具加载特定 skill（如 `superpowers:test-driven-development`）。
