...
class DailyStatsServiceImplTest extends BaseMockitoUnitTest {
    ...
    @Test
    void testGetDailyStatsSummary_WithData() {
        // Given
        LocalDate startDate = LocalDate.of(2024, 1, 1);
        LocalDate endDate = LocalDate.of(2024, 1, 31);

        DailyStatsPageReqVO reqVO = new DailyStatsPageReqVO();
        ...
        when(dailyStatsMapper.selectListByCondition(any(), any(), any(LocalDate.class), any(LocalDate.class)))
                .thenReturn(statsList);

        // When
        DailyStatsSummaryRespVO result = dailyStatsService.getDailyStatsSummary(reqVO);
        ...
        verify(dailyStatsMapper).selectListByCondition(null, null, startDate, endDate);
    }

    @Test
    void testGetDailyStatsSummary_EmptyData() {
        // Given
        LocalDate startDate = LocalDate.of(2024, 1, 1);
        LocalDate endDate = LocalDate.of(2024, 1, 31);
    ...
    @Test
    void testGetDailyStatsSummary_CalculatesEpcCorrectly() {
        // Given
        LocalDate startDate = LocalDate.of(2024, 1, 1);
        LocalDate endDate = LocalDate.of(2024, 1, 31);
